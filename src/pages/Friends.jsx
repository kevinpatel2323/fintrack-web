...
export default function Friends() {
  ...
  return (
    ...
    <section className="card">
      ...
      {!editFriendId && !createFormOpen && (
        <div className="friend-add-trigger">
          <button
            type="button"
            className="primary"
            onClick={() => {
            ...
            return (
              <article className="friend-card" key={friend.id}>
                <div className="friend-header">
                  ...
                  <div className="friend-header__tools">
                    <div className="friend-card__icon-btns" role="group" aria-label={`${friend.name} quick actions`}>
                      <button
                        type="button"
                        className="friend-card__icon-btn"
                      ...
                      <button
                        type="button"
                        className="friend-card__icon-btn friend-card__icon-btn--danger"
