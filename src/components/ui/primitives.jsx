  ...
  return (
    <div
      ...
      style={{
        ...
        height: size,
        borderRadius: '50%',
        background: `linear-gradient(135deg, ${t}33, ${t}11)`,
  ...
  return (
    <button
      ...
      style={{
        ...
        color: active ? (tint ? '#fff' : 'var(--ft-text-on-accent)') : 'var(--ft-text-dim)',
        padding: '7px 13px',
        borderRadius: 999,
        fontFamily: 'var(--ft-font-ui)',
        fontSize: 13,
    ...
    <div
      style={{
        background: accent
          ...
          : 'var(--ft-surface)',
        border: accent ? '1px solid rgba(215,255,61,0.33)' : '1px solid var(--ft-border)',
        borderRadius: 16,
        padding: 16,
        position: 'relative',
        overflow: 'hidden',
